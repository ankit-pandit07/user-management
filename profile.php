...
<!-- 
        ...
        <div class="card border-primary align-self-center">
            <?php if(!$cphoto):?>
                <img src="assets/img/sukuna.jpeg" class="img-thumbnail img-fluid" width="408px">
                <?php else:?>
...
<div class="tab-pane container fase" id="editProfile">
<div class="card-deck">
...
<div class="card-deck">
    <div class="card border-success">
        <div class="card-header bg-success text-white text-center laed">
            Change Password
        </div>
