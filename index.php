...
<body>
    ...
    <div class="card rounded-left p-4" style="flex-grow:1.4;">
        ...
        <div class="form-group">
            <div class="custom-control custom-checkbox float-left">
                ...
                <label for="customCheck" class="custom-control-label">Remeber me</label>
                   </div>
    ...
    <div class="card justify-center-center rounded-right myColor p-4">
        ...
        <button class="btn btn-outline-light bthn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="register-link">Sign up</button>
    </div>
    </div>
    </div>
    </div>
    ...
    <div class="col-lg-10 my-auto">
    <div class="card-group myShadow">
         <div class="card justify-center-center rounded-left myColor p-4">
        ...
        <button class="btn btn-outline-light bthn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="login-link">Sign In</button>
    </div>
    ...
    <div class="card-group myShadow">
        ...
        <hr class="my-3 bg-light myHr">
        <button class="btn btn-outline-light bthn-lg align-self-center font-weight-bolder mt-4 myLinkBtn" id="back-link">Back</button>
    </div>
    <div class="card rounded-right p-4" style="flex-grow:1.4;">
        <h1 class="text-center font-weight-bold text-primary">Forgot Your Password</h1>
        <hr class=""my-3>
        <p class="lead text-center text-secondary">To reset your password,
            enter the registered e-mail address and we will send you the rest instructions on your e-mail!
        </p>
