...
<div class="container">
    ...
    <?php if($verified == 'Not Verified!'): ?>
        ...
        <strong>Your E-mail is not verified! We've sent you an E-mail 
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("body").on("click",".deleteBtn", function(e){
              ...
              //Display Note of An User in Details Ajac request
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        Swal.fire({
                            ...
                            type:'info',
                            html:'<br>Title : </br>'+data.title+'<br><br><b>Note : </b>'+data.note+'<br><br><b>Written On : </b>'+data.created_at+'<br><br><b>Updated On : </b>'+data.updated_at,
