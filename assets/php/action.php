...
if(isset($_POST['action']) && $_POST['action'] == 'forgot'){
    ...
    if($user_found !=null){
        ...
        try{
            ...
            <a href="http://localhost/user-system/reset-pss.php?email='.$email.'&token='.$token.'">http://localhost/user-system/reset-pss.php?email='.$email.'&token='.$token.'</a><br>Regards<br>User Management!</h3>';

            $mail->send();
            echo $curser->showMessage('success','We have send you the reset link in your e-mail ID, Please check your e-mail!');
        ...
        echo $curser->showMessage('info','This e-mail is not registered!');
    }
}
